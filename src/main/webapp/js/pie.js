(function () {
    ...
    h.AmPieChart = h.Class({
        inherits: h.AmSlicedChart, construct: function (d) {
            this.type = "pie";
            ...
            if (h.ifArray(d)) {
                if (0 < this.realWidth && 0 < this.realHeight) {
                    ...
                    this.realHeight = m;
                    var e = h.toCoordinate, k = e(this.marginLeft, b), a = e(this.marginRight, b),
                        v = e(this.marginTop, m) + this.getTitleHeight(), n = e(this.marginBottom, m), y, z, g,
                        x = h.toNumber(this.labelRadius), q =
                    ...
                    for (k = 0; k < d.length; k++) if (a = d[k], !0 !== a.hidden && 0 < a.percents) {
                        var r = 360 * a.percents / 100, q = Math.sin((n + r / 2) / 180 * Math.PI),
